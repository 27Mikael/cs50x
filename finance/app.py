...
# DONE: Show portfolio of stocks
# TODO: figure out how to handle sells
# TODO: only grand total the purchases(or figure out how  to accurately reflect)
@app.route("/")
@login_required
def index():
...
def sell():
    ...
    if table_check and request.method == "POST":
